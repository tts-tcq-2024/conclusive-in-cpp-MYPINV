...
**I plan to increase code coverage by writing unit tests for critical modules, focusing on edge cases to reduce the likelihood of bugs. Also, i plan to take care of CCN and will try to write code which can be reused**
